...
data <- as.rds.data.frame(df=data,id="id",
                          recruiter.id="rec.id",
                          network.size="degree",
...
#ttest
t.test(data$age[data$disease=="Disease"], data$age[data$disease=="No Disease"], var.equal = T)
#SPRTCA
sprtca(1000, "disease", "age", data)

#association between sex and age
#ttest
t.test(data$age[data$sex == "Male"], data$age[data$sex=="Female"], var.equal = T)
#SPRTCA
sprtca(1000, "sex", "age", data)
