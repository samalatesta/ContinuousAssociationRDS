...
case1 <- sim(n,iter, 5, 500, .5,.5, 0,ef,"AA=.5, BB=.5, r=0")
case2 <- sim(n, iter, 5, 500, .5, .5, .25,ef, "AA=.5, BB=.5, r=.25")
case3 <- sim(n, iter, 5,500, .5, .5, .5, ef, "AA=.5, BB=.5, r=.5")
case4 <- sim(n, iter,5, 500, .5, .5, .75, ef, "AA=.5, BB=.5, r=.75")
case5 <- sim(n, iter,5, 500, .5, .5, 0.9,ef, "AA=.5, BB=.5, r=.9")
case6 <- sim(n, iter, 5,500, .75, .75, 0, ef, "AA=.75, BB=.75, r=0")
case7 <- sim(n, iter, 5,500, .75, .75, .25,ef, "AA=.75, BB=.75, r=.25")
case8 <- sim(n, iter, 5,500, .75, .75, .5,ef, "AA=.75, BB=.75, r=.5")
case9 <- sim(n, iter, 5,500, .75, .75, 0.75,ef, "AA=.75, BB=.75, r=.75")
case10 <- sim(n, iter, 5,500, .75, .75, 0.9,ef, "AA=.75, BB=.75, r=.9")
case11 <- sim(n, iter, 5,500, .9, .9, 0, ef, "AA=.9, BB=.9, r=0")
case12 <- sim(n, iter, 5,500, .9, .9, 0.25, ef,"AA=.9, BB=.9, r=.25")
case13 <- sim(n,iter, 5,500, .9, .9, .5, ef,"AA=.9, BB=.9, r=.5")
case14 <- sim(n, iter, 5,500, .9, .9, .75, ef, "AA=.9, BB=.9, r=.75")
case15 <- sim(n, iter, 5,500, .9, .9, .9, ef, "AA=.9, BB=.9, r=.9") 
...
write.csv(result, paste0("power_ttest_continuous_ef",ef, "_",l,".csv"), row.names=F)
