...
#simulations to run
case1 <- sim(n,iter,  5, 500, 0, 0, "r1=0, r2=0", ef)
case2 <- sim(n, iter,5, 500, 0, .25,"r1=0, r2=.25", ef)
case3 <- sim(n,iter, 5, 500, 0, .5, "r1=0, r2=.5", ef)
case4 <- sim(n,iter, 5, 500, 0, .75, "r1=0, r2=.75", ef)
case5 <- sim(n,iter, 5, 500, .25, 0, "r1=.25, r2=.0", ef)
case6 <- sim(n,iter, 5, 500, .25, .25, "r1=.25, r2=.25", ef)
case7 <- sim(n, iter,5, 500, .25, .5, "r1=.25, r2=.5", ef)
case8 <- sim(n, iter,5, 500, .25, .75, "r1=.25, r2=.75", ef)
case9 <- sim(n, iter,5, 500, .5, 0, "r1=.5, r2=0", ef)
case10 <- sim(n,iter, 5, 500, .5, .25, "r1=.5, r2=.25", ef)
case11 <- sim(n,iter, 5, 500, .5, .5, "r1=.5, r2=.5", ef)
case12 <- sim(n,iter, 5, 500, .5, .75, "r1=.5, r2=.75", ef)
case13 <- sim(n,iter, 5, 500, .75, 0, "r1=.75, r2=0", ef)
case14 <- sim(n,iter, 5, 500, .75, .25, "r1=.75, r2=.25", ef)
case15 <- sim(n, iter,5, 500, .75, .5, "r1=.75, r2=.5", ef)
case16 <- sim(n,iter, 5, 500, .75, .75, "r1=.75, r2=.75", ef)
...
write.csv(result, paste0("power_pearson_ef",ef, "_",l,".csv"), row.names=F)
